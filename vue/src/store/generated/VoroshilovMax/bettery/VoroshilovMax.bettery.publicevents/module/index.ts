...
const txClient = async (wallet: OfflineSigner, { addr: addr }: TxClientOptions = { addr: "http://localhost:26657" }) => {
  ...
  return {
    ...
    msgUpdateRefPubEvents: (data: MsgUpdateRefPubEvents): EncodeObject => ({ typeUrl: "/VoroshilovMax.bettery.publicevents.MsgUpdateRefPubEvents", value: data }),
    msgDeleteRefPubEvents: (data: MsgDeleteRefPubEvents): EncodeObject => ({ typeUrl: "/VoroshilovMax.bettery.publicevents.MsgDeleteRefPubEvents", value: data }),
