...
const txClient = async (wallet, { addr: addr } = { addr: "http://localhost:26657" }) => {
    ...
    return {
        ...
        msgUpdateFihishPubEvent: (data) => ({ typeUrl: "/VoroshilovMax.bettery.publicevents.MsgUpdateFihishPubEvent", value: data }),
        ...
        msgDeleteFihishPubEvent: (data) => ({ typeUrl: "/VoroshilovMax.bettery.publicevents.MsgDeleteFihishPubEvent", value: data }),
    };
};
