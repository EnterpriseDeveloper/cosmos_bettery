...
const txClient = async (wallet, { addr: addr } = { addr: "http://localhost:26657" }) => {
    ...
    return {
        ...
        msgDeleteRefundPubEvents: (data) => ({ typeUrl: "/VoroshilovMax.bettery.publicevents.MsgDeleteRefundPubEvents", value: data }),
        msgCreatePartPubEvents: (data) => ({ typeUrl: "/VoroshilovMax.bettery.publicevents.MsgCreatePartPubEvents", value: data }),
        msgUpdateRefundPubEvents: (data) => ({ typeUrl: "/VoroshilovMax.bettery.publicevents.MsgUpdateRefundPubEvents", value: data }),
