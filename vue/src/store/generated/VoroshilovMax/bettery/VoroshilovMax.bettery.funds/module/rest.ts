...
export interface FundsMsgCreateMintBetResponse {
  /** @format uint64 */
  id?: string;
}
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   *
   * @tags Query
   * @name QueryMintBetAll
   * @summary Queries a list of mintBet items.
   * @request GET:/VoroshilovMax/bettery/funds/mintBet
   */
  queryMintBetAll = (
    query?: {
    ...
    this.request<FundsQueryAllMintBetResponse, RpcStatus>({
      path: `/VoroshilovMax/bettery/funds/mintBet`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
