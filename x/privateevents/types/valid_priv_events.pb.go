...
func (m *ValidPrivEvents) GetPrivId() string {
	if m != nil {
		return m.PrivId
	}
	return ""
...
var fileDescriptor_8a70584f522dd3ec = []byte{
	...
	0x20, 0xa6, 0xcc, 0x14, 0x21, 0x31, 0x2e, 0x36, 0x90, 0x1d, 0x9e, 0x29, 0x12, 0xcc, 0x60, 0x85,
	0x50, 0x1e, 0x48, 0x3c, 0x31, 0xaf, 0xb8, 0x3c, 0xb5, 0x48, 0x82, 0x05, 0x22, 0x0e, 0xe1, 0x39,
	...
	0x46, 0x69, 0x92, 0x5e, 0x72, 0x7e, 0xae, 0x3e, 0x8a, 0x67, 0xf4, 0xa1, 0x9e, 0xd1, 0xaf, 0xd0,
	0x47, 0x0d, 0x8b, 0x92, 0xca, 0x82, 0xd4, 0xe2, 0x24, 0x36, 0xb0, 0x2f, 0x8c, 0x01, 0x01, 0x00,
	0x00, 0xff, 0xff, 0x27, 0x9a, 0x94, 0xf2, 0x29, 0x01, 0x00, 0x00,
}
...
func (m *ValidPrivEvents) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.PrivId) > 0 {
		...
		i = encodeVarintValidPrivEvents(dAtA, i, uint64(len(m.PrivId)))
		i--
		dAtA[i] = 0x1a
	}
	if m.Id != 0 {
