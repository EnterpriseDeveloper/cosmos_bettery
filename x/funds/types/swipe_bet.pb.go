...
func (m *SwipeBet) GetUserId() string {
	if m != nil {
		return m.UserId
	}
	return ""
...
var fileDescriptor_8e2f5655ae0fa339 = []byte{
	...
	,
}
...
func (m *SwipeBet) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.UserId) > 0 {
		...
		i = encodeVarintSwipeBet(dAtA, i, uint64(len(m.UserId)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.Amount) > 0 {
	...
	if m.Id != 0 {
		i = encodeVarintSwipeBet(dAtA, i, uint64(m.Id))
		i--
		dAtA[i] = 0x10
	}
	if len(m.Creator) > 0 {
