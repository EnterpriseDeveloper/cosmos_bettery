...
func (m *SwipeBet) GetAmount() int64 {
	if m != nil {
		return m.Amount
	}
	return 0
...
var fileDescriptor_8e2f5655ae0fa339 = []byte{
	...
	0x12, 0x4c, 0x0a, 0x8c, 0x1a, 0xcc, 0x41, 0x50, 0x1e, 0x48, 0xbc, 0xb4, 0x38, 0xb5, 0xc8, 0x33,
	0x45, 0x82, 0x19, 0x22, 0x0e, 0xe1, 0x39, 0x79, 0x9c, 0x78, 0x24, 0xc7, 0x78, 0xe1, 0x91, 0x1c,
	...
	0x0d, 0xec, 0x4c, 0x63, 0x40, 0x00, 0x00, 0x00, 0xff, 0xff, 0xbd, 0xbe, 0x93, 0xab, 0xf2, 0x00,
	0x00, 0x00,
}
...
func (m *SwipeBet) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Amount != 0 {
		i = encodeVarintSwipeBet(dAtA, i, uint64(m.Amount))
		i--
		dAtA[i] = 0x10
	}
	if len(m.Creator) > 0 {
...
func (m *SwipeBet) Size() (n int) {
	...
	if m.Amount != 0 {
		n += 1 + sovSwipeBet(uint64(m.Amount))
	}
	if m.UserId != 0 {
