...
func (m *MintBet) GetReciever() string {
	if m != nil {
		return m.Reciever
	}
	return ""
...
var fileDescriptor_ba03dbafdf568720 = []byte{
	...
	0x07, 0xab, 0xd3, 0x07, 0xb1, 0x20, 0x5a, 0x94, 0xea, 0xb9, 0xd8, 0x7d, 0x33, 0xf3, 0x4a, 0x9c,
	...
	,
}
...
func (m *MintBet) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Reciever) > 0 {
		...
		i = encodeVarintMintBet(dAtA, i, uint64(len(m.Reciever)))
		i--
		dAtA[i] = 0x1a
	}
	if m.Id != 0 {
		i = encodeVarintMintBet(dAtA, i, uint64(m.Id))
		i--
		dAtA[i] = 0x10
	}
	if len(m.Creator) > 0 {
