...
func (m *MintBet) GetAmount() int64 {
	if m != nil {
		return m.Amount
	}
	return 0
...
var fileDescriptor_ba03dbafdf568720 = []byte{
	...
	0x09, 0x26, 0x05, 0x46, 0x0d, 0xe6, 0x20, 0x28, 0x0f, 0x24, 0x5e, 0x5a, 0x9c, 0x5a, 0xe4, 0x99,
	0x22, 0xc1, 0x0c, 0x11, 0x87, 0xf0, 0x9c, 0x3c, 0x4e, 0x3c, 0x92, 0x63, 0xbc, 0xf0, 0x48, 0x8e,
	...
	0x06, 0x76, 0xa5, 0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0x80, 0xd2, 0xdb, 0x71, 0xf0, 0x00, 0x00,
	0x00,
}
...
func (m *MintBet) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Amount != 0 {
		i = encodeVarintMintBet(dAtA, i, uint64(m.Amount))
		i--
		dAtA[i] = 0x10
	}
	if len(m.Creator) > 0 {
...
func (m *MintBet) Size() (n int) {
	...
	if m.Amount != 0 {
		n += 1 + sovMintBet(uint64(m.Amount))
	}
	if m.UserId != 0 {
