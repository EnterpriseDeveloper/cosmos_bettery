...
func (m *RefPubEvents) GetId() uint64 {
	if m != nil {
		return m.Id
	}
	return 0
...
func (m *RefPubEvents) GetPubId() string {
	if m != nil {
		return m.PubId
	}
	return ""
...
var fileDescriptor_dde59465f8f89dcb = []byte{
	...
	0x4a, 0xb3, 0x18, 0xb9, 0x78, 0x82, 0x52, 0xd3, 0x02, 0x4a, 0x93, 0x5c, 0xc1, 0xca, 0x84, 0x24,
	...
	,
}
...
func (m *RefPubEvents) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.PubId) > 0 {
		i -= len(m.PubId)
		copy(dAtA[i:], m.PubId)
		i = encodeVarintRefPubEvents(dAtA, i, uint64(len(m.PubId)))
		i--
		dAtA[i] = 0x1a
	}
	if m.Id != 0 {
		i = encodeVarintRefPubEvents(dAtA, i, uint64(m.Id))
		i--
		dAtA[i] = 0x10
	}
	if len(m.Creator) > 0 {
...
func (m *RefPubEvents) Size() (n int) {
	...
	if m.Id != 0 {
		n += 1 + sovRefPubEvents(uint64(m.Id))
	}
	l = len(m.PubId)
	if l > 0 {
		n += 1 + l + sovRefPubEvents(uint64(l))
