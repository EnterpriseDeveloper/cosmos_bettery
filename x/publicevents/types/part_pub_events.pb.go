...
func (m *PartPubEvents) GetPubId() string {
	if m != nil {
		return m.PubId
	}
	return ""
...
var fileDescriptor_4860d65d15f88f4c = []byte{
	...
	0x9d, 0x4a, 0x8d, 0x8c, 0x5c, 0xbc, 0x01, 0x89, 0x45, 0x25, 0x01, 0xa5, 0x49, 0xae, 0x60, 0x75,
	...
	0x10, 0x53, 0x66, 0x8a, 0x90, 0x08, 0x17, 0x6b, 0x41, 0x69, 0x92, 0x67, 0x8a, 0x04, 0x33, 0x58,
	0x1d, 0x84, 0x03, 0xd2, 0x9f, 0x98, 0x57, 0x5c, 0x9e, 0x5a, 0x54, 0x2c, 0xc1, 0x02, 0xd1, 0x0f,
	0xe5, 0x0a, 0x89, 0x71, 0xb1, 0x25, 0xe6, 0xe6, 0x97, 0xe6, 0x95, 0x48, 0xb0, 0x82, 0x25, 0xa0,
	0x3c, 0x27, 0xff, 0x13, 0x8f, 0xe4, 0x18, 0x2f, 0x3c, 0x92, 0x63, 0x7c, 0xf0, 0x48, 0x8e, 0x71,
	0xc2, 0x63, 0x39, 0x86, 0x0b, 0x8f, 0xe5, 0x18, 0x6e, 0x3c, 0x96, 0x63, 0x88, 0x32, 0x4d, 0xcf,
	0x2c, 0xc9, 0x28, 0x4d, 0xd2, 0x4b, 0xce, 0xcf, 0xd5, 0x47, 0xf1, 0xa2, 0x3e, 0xd4, 0x8b, 0xfa,
	0x15, 0xfa, 0x28, 0xc1, 0x53, 0x52, 0x59, 0x90, 0x5a, 0x9c, 0xc4, 0x06, 0xf6, 0x9b, 0x31, 0x20,
	0x00, 0x00, 0xff, 0xff, 0x7e, 0x5c, 0x9e, 0x23, 0x3b, 0x01, 0x00, 0x00,
}
...
func (m *PartPubEvents) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.PubId) > 0 {
		i -= len(m.PubId)
		copy(dAtA[i:], m.PubId)
		i = encodeVarintPartPubEvents(dAtA, i, uint64(len(m.PubId)))
		i--
		dAtA[i] = 0x1a
	}
	if m.Id != 0 {
